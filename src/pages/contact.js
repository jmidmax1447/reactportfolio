...
function Contact () {
    ...
    let [errors, setErrors] = useState ({ name: "", email: ""});
    ...
    function handleSubmit(event) {
      ...
      if (!nameRegex.test(form.name.trim())) {
        nextErrors.name = "Please enter a valid name (letters only, 2–50 characters).";
      }
      ...
      if (nextErrors.name.length || nextErrors.email.length) 
      return;

      console.log("Valid form (not sending):", form);
    };
    return (
      <motion.div
      ...
      >
        <div className="contact-background">
          <div className="contact-form-card">
            ...
            <p className="contacttext">Send a message or an inquiry.</p>
            ...
            >
              ...
              <div className="form-field">
                ...
                />
                {errors.subject && <p className="form-error">
                  {errors.subject}</p>}
              </div>
              ...
              <div className="form-field">
                ...
                />
                {errors.message && <p className="form-error">
                  {errors.message}</p>}
              </div>
      ...
      <div className="contact-background">
        <div className="contact">
          ...
          <p className="contacttext">Stay Connected!</p>
